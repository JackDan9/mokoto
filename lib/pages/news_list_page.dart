...
import '../components/common_end_line.dart';
import '../widgets/slide_view_indicator.dart';
...
//        print("load more ... ");
  ...
  Widget renderRow(i) {
    ...
    if (itemData is String && itemData == Config.endLineTag) {
